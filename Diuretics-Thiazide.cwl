...
steps:
  ...
  totaretic-diuretics-thiazide---primary:
    run: totaretic-diuretics-thiazide---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diuretics-thiazide-maleate---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: totaretic-diuretics-thiazide---primary/output
  ...
  diuretics-thiazide-spiroco---primary:
    run: diuretics-thiazide-spiroco---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diuretics-thiazide-lisinopril---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diuretics-thiazide-spiroco---primary/output
  ...
  diuretics-thiazide-arginine---primary:
    run: diuretics-thiazide-arginine---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diuretics-thiazide-capozide---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diuretics-thiazide-arginine---primary/output
  ...
  diuretics-thiazide-cotriamterzide---primary:
    run: diuretics-thiazide-cotriamterzide---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diuretics-thiazide-astrazenec---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diuretics-thiazide-cotriamterzide---primary/output
